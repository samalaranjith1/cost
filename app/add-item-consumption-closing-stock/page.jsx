...
export default function AddConsumptionClosingStockPage() {  const [date, setDate] = useState('');
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await apiRequest('POST', 'items/consumption/closing/upsert', { list: data });
  ...
  return (
    <DashboardLayout title="Add Kitchen Closing Stock">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
              <div>
                ...
                <p className="text-gray-500 text-sm">Record your end-of-day inventory quantities</p>
              </div>
              <button
            ...
            <div className="mb-8">
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all"
              />
            </div>
              ...
              {rows.map((row) => (
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Closing Quantity</label>
                        ...
                        <div className="mt-2 p-3 bg-purple-50 border border-purple-200 rounded-lg text-xs">
                          <div className="flex gap-4">
                            <div className="text-purple-700 font-medium">
                              Unit Price: <span className="text-purple-800">{getItemPrice(row.itemId, row.quantity).unitPrice}</span>
                            </div>
                            <div className="text-purple-700 font-medium">
                              Total Price: <span className="text-purple-800">{getItemPrice(row.itemId, row.quantity).totalPrice}</span>
                            </div>
                          </div>
                        </div>
                      )}
