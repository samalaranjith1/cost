...
export default function UploadSalesDataGlokalPage() {  const [selectedFile, setSelectedFile] = useState(null);
  ...
  const handleUpload = async () => {
    ...
    try {
      const data = await fileUploadRequest('POST', 'sales/upload?sourcetypeid=2', formData);
