...
export default function AddDepartmentsPage() {  const [rows, setRows] = useState([{ id: Date.now(), name: '' }]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await apiRequest('POST', 'delicia-meta/department/upsert', { list: validData });
  ...
  return (
    <DashboardLayout title="Add Departments">
