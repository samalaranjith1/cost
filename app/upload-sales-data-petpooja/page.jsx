...
export default function UploadSalesDataPetpoojaPage() {  const [selectedFile, setSelectedFile] = useState(null);
  ...
  const handleUpload = async () => {
    ...
    try {
      const data = await fileUploadRequest('POST', 'sales/upload?sourcetypeid=1', formData);
